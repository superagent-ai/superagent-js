...
export class Llm {
    ...
    public async list(): Promise<SuperAgent.LlmList> {
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), "api/v1/llms"),
            method: "GET",
            headers: {
    ...
    public async get(llmId: string): Promise<SuperAgent.AppModelsResponseLlm> {
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), `api/v1/llms/${llmId}`),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "X-Fern-Language": "JavaScript",
