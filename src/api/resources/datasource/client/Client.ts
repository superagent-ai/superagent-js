...
export class Datasource {
    ...
    public async list(): Promise<SuperAgent.DatasourceList> {
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), "api/v1/datasources"),
            method: "GET",
            headers: {
    ...
    public async get(datasourceId: string): Promise<SuperAgent.AppModelsResponseDatasource> {
        const _response = await core.fetcher({
            url: urlJoin(await core.Supplier.get(this._options.environment), `api/v1/datasources/${datasourceId}`),
            method: "GET",
            headers: {
                Authorization: await this._getAuthorizationHeader(),
                "X-Fern-Language": "JavaScript",
